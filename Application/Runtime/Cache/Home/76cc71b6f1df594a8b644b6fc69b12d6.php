...
<div class="main">
<p>已有成绩列表：</p>
<form id="form1" name="form1" method="post" action="<?php echo U('list_ceping1');?>">
  搜索: 
...
<div class="ull">
    <ul style="list-style: none;position:absolute;top:660px;font-size:23px;color:white;">
      <?php if($page > 1): ?><li><a class="btn btn-primary glyphicon glyphicon-chevron-left" href="<?php echo U('list_ceping1', array('page'=>$pre));?>"></a></li><?php endif; ?>
      
      <?php $__FOR_START_16776__=1;$__FOR_END_16776__=$pages+1;for($i=$__FOR_START_16776__;$i < $__FOR_END_16776__;$i+=1){ ?><li><a class="btn btn-primary" style="font-size:16px;" href="<?php echo U('list_ceping1', array('page'=>$i));?>"><?php echo ($i); ?></a></li><?php } ?>

      <?php if($page < $pages): ?><li><a  class="btn btn-primary glyphicon glyphicon-chevron-right" href="<?php echo U('list_ceping1', array('page'=>$next));?>"></a></li><?php endif; ?>
    </ul>
  </div>
</div>
</body>
