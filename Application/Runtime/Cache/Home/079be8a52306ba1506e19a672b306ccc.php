...
<div class="main">
  <p>等待回复留言列表：</p>
<form id="form1" name="form1" method="get" action="<?php echo U('Message/message_check1');?>">
  搜索:学号:
...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#6699CC" style="border-collapse:collapse">  
  ...
  <?php if(is_array($data)): foreach($data as $k=>$value): ?><tr>
      ...
      <td><a href="<?php echo U('Home/Message/reply1', array('id'=>$value['id']));?>" title="回复"><span class="glyphicon glyphicon-pencil"></span></a>&nbsp; <a href="<?php echo U('Home/Message/del1', array('id'=>$value['id']));?>" title="删除"><span class="glyphicon glyphicon-trash"></span></a></td>
