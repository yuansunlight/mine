...
<body>
  <div class="main">
    <div class="book">
  <p>已有学生列表：</p>
<form id="form1" name="form1" method="post" action="<?php echo U('manage');?>">
  搜索:
...
<div class="ull">
    ...
    <?php $__FOR_START_30356__=1;$__FOR_END_30356__=$pages+1;for($i=$__FOR_START_30356__;$i < $__FOR_END_30356__;$i+=1){ ?><li><a class="btn btn-primary" style="font-size:16px;" href="<?php echo U('manage', array('page'=>$i));?>"><?php echo ($i); ?></a></li><?php } ?>
