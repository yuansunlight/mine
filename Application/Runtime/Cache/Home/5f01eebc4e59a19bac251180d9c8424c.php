...
<br><br>                                                               
<form id="form1" name="form1" method="post" action="<?php echo U('User/banzhuren_edit',array('id'=>$data['id']));?>">
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#6699CC" style="border-collapse:collapse">    
    ...
    <tr><td>班级：</td><td><input name='classes' type='text' id='classes' value='<?php echo ($data["classes"]); ?>' />&nbsp;*</td><tr>
      <td>&nbsp;</td>
