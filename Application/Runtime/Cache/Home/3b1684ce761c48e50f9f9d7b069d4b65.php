...
<body>
  <div class="main">
    <div class="select">
  <form id="form1" name="form1" method="post" action="<?php echo U('teachersee');?>">
  ...
  <select name="mingcheng" id="mingcheng" onChange="autoSubmit();">
    <option  value="">奖项</option>
    <?php if(is_array($ming)): foreach($ming as $key=>$value): ?><option value="<?php echo ($value); ?>"><?php echo ($value); ?></option>
    <?php if($mingcheng == $value): ?><option value="<?php echo ($value); ?>" selected><?php echo ($value); ?></option><?php endif; endforeach; endif; ?>
...
<div class="table">
  ...
  <tr>
    ...
    <td width="90" bgcolor='#EBE2FE'>申请理由</td>
    <td width="90" align="center" bgcolor="#EBE2FE">测评详情</td>
    <td width="90" align="center" bgcolor="#EBE2FE">申请时间</td>
  </tr>
</table>
<br>
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#6699CC" style="border-collapse:collapse">  
  <?php if($count3 > 0): ?><p style="text-align: center;">优秀学生干部名单(<?php echo ($count3); ?>人)</p><?php endif; ?>
...
<br>
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#6699CC" style="border-collapse:collapse">  
  <?php if($count1 > 0): ?><p style="text-align: center;">优秀学生名单(<?php echo ($count1); ?>人)</p><?php endif; ?>
...
<br>
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#6699CC" style="border-collapse:collapse"><?php if($count2 > 0): ?><p style="text-align: center;">先进个人名单(<?php echo ($count2); ?>人)</p><?php endif; ?>
