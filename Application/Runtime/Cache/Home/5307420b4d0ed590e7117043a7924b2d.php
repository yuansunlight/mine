...
<div class="main">
	<h1>发布奖优通知</h1>
	<br>
	<form id="form1" name="form1" method="post" action="<?php echo U('Notice/add_notice');?>">
<table width="50%" border="1" align="center" cellpadding="3" bordercolor="#6699CC" cellspacing="1" bordercolor="white" style="border-collapse:collapse">    
	<tr><td>标题：</td><td><input name='biaoti' type='text' id='biaoti' value='' size='49'  />&nbsp;</td></tr><tr><td>类别：</td><td><input name='leibie' type='text' id='leibie'  />&nbsp;</td></tr>
	</tr>
	<tr><td>内容：</td>
	...
	<tr><td>添加人：</td><td><input name='tianjiaren' type='text' id='tianjiaren' value="<?php echo ($username); ?>" />&nbsp;</td></tr>
