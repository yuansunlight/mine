                    ...
                    <td><table id="__01" width="725" height="208" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          ...
                          <td width="703" height="208" valign="top">
                            <form name="form1" method="post" action="<?php echo U('publish');?>">
                            <table width="96%" border="1" align="left" cellpadding="3" cellspacing="1" bordercolor="#B8D8E8" style="border-collapse:collapse">
                              <tr>
                                ...
                                <td><input style='border:0px' name='zhanghao' type='text' id='zhanghao' value='<?php echo ($username); ?>' />
                                  &nbsp;</td>
                              </tr>
                           
                              <tr>
                                <td style='height:30px'>姓名：</td>
                                <td><input style='border:0px' name='xingming' type='text' id='xingming' value='<?php echo ($name); ?>' />
                                  &nbsp;</td>
                              </tr>
                               
                              <tr>
                                <td>留言问题：</td>
                                <td><textarea  style='border:0px' name='liuyan' cols='50' rows='8' bordercolor="#B8D8E8" id='liuyan'></textarea>
                                  &nbsp;</td>
                              </tr>
                              <tr>
                                <td >&nbsp;</td>
