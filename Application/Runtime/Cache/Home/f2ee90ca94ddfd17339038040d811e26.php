...
<body>
  <div class="main">
    <div class="select">
  <form id="form1" name="form1" method="post" action="<?php echo U('jiang');?>">
...
<br>
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#6699CC" style="border-collapse:collapse"> 
<?php if($count1 > 0): ?><p style="text-align: center;">院长奖申报名单(名额为:<?php echo ($yi); ?>)</p><?php endif; ?>
  <?php if(is_array($data1)): foreach($data1 as $k=>$value): ?><tr>
      ...
      <td width="90"> 
       <!--  <a href="<?php echo U('Home/Jiangjin/', array('id'=>$value['id']));?>"><input type="radio" name=""></a> -->
        <?php if($value["status"] == 0): ?><a href="<?php echo U('Home/Jiangjin/pass1', array('id'=>$value['id']));?>" title="点击通过"><span class="glyphicon glyphicon-star-empty"></span></a><?php endif; ?>
        <?php if($value["status"] == 1): ?><a href="<?php echo U('Home/Jiangjin/pass1', array('id'=>$value['id']));?>" title="点击不通过"><span class="glyphicon glyphicon-star"></span></a><?php endif; ?>
    </td>
    </tr><?php endforeach; endif; ?>
</table>
<br>
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#6699CC" style="border-collapse:collapse"> 
  <?php if($count2 > 0): ?><p style="text-align: center;">竞赛单项奖申报名单(名额为:<?php echo ($er); ?>)</p><?php endif; ?>
   <?php if(is_array($data2)): foreach($data2 as $k=>$value): ?><tr> 
      ...
      <td width="90">
       <?php if($value["status"] == 0): ?><a href="<?php echo U('Home/Jiangjin/pass1', array('id'=>$value['id']));?>" title="点击通过"><span class="glyphicon glyphicon-star-empty"></span></a><?php endif; ?>
        <?php if($value["status"] == 1): ?><a href="<?php echo U('Home/Jiangjin/pass1', array('id'=>$value['id']));?>" title="点击不通过"><span class="glyphicon glyphicon-star"></span></a><?php endif; ?></td>
    </tr><?php endforeach; endif; ?>
</table>
<br>
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#6699CC" style="border-collapse:collapse"><?php if($count3 > 0): ?><p style="text-align: center;">公益单项奖申报名单(名额为:<?php echo ($san); ?>)</p><?php endif; ?>
