...
<body>
  <div>
    ...
    <div style="margin-top: 35px;margin-left:50px;">
      <form id="form1" name="form1" method="get" action="<?php echo U('Notice/notice');?>">
...
<div>
    ...
    <?php if($page > 1): ?><li  style="float:left;margin-right:30px;"><a class="btn btn-primary glyphicon glyphicon-chevron-left" href="<?php echo U('notice', array('page'=>$pre));?>"></a></li><?php endif; ?>
    
    <?php $__FOR_START_22827__=1;$__FOR_END_22827__=$pages+1;for($i=$__FOR_START_22827__;$i < $__FOR_END_22827__;$i+=1){ ?><li  style="float:left;margin-right:30px; "><a class="btn btn-primary" style="font-size:16px;" href="<?php echo U('notice', array('page'=>$i));?>"><?php echo ($i); ?></a></li><?php } ?>

    <?php if($page < $pages): ?><li style="float:left;margin-right:30px;"><a  class="btn btn-primary glyphicon glyphicon-chevron-right" href="<?php echo U('notice', array('page'=>$next));?>"></a></li><?php endif; ?>
    </ul>
  </div>
  </div>
