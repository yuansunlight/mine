...
<div class="main">
  <div class="book">
    <h2>教师信息</h2>
<form id="form1" name="form1" method="get" action="<?php echo U('banzhuzren_list');?>">
  搜索:账号:
...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#6699CC" style="border-collapse:collapse">  
  <tr>
    ...
    <td width="94" bgcolor='#EBE2FE'>班级</td>
  ...
  <?php if(is_array($data)): foreach($data as $k=>$value): ?><tr>
      ...
      <td><a href="<?php echo U('Home/User/banzhuren_edit', array('id'=>$value['id']));?>" title="编辑"><span class="glyphicon glyphicon-pencil"></span></a>&nbsp;
         <a href="<?php echo U('Home/User/banzhuren_del', array('id'=>$value['id']));?>" title="删除"><span class="glyphicon glyphicon-trash"></span></a>
        </td> 
...
<!-- <div class="ull">
    ...
    <?php $__FOR_START_15408__=1;$__FOR_END_15408__=$pages+1;for($i=$__FOR_START_15408__;$i < $__FOR_END_15408__;$i+=1){ ?><li><a class="btn btn-primary" style="font-size:16px;" href="<?php echo U('manage', array('page'=>$i));?>"><?php echo ($i); ?></a></li><?php } ?>
