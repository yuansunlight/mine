...
<br><br>
<form id="form1" name="form1" method="post" action="<?php echo U('User/add_banzhuren');?>">
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#6699CC" style="border-collapse:collapse">    
    ...
    <tr><td class="td">班级：</td><td><input name='classes' type='text' id='classes' value='' />&nbsp;</td><tr>
      <td>&nbsp;</td>
...
<form enctype="multipart/form-data" action="<?php echo U('banzhurenupload');?>" method="post">
  <tr><td ><font style="font-size: 30px;  font-family: 华文彩云;" >批量添加</font></td></tr>
    <br>
  <table>
   
    <tr><td>请先<a href="/sss/Public/home/excel/banzhuren.xls" rel="external nofollow" ><font style="color: blue;" >下载添加教师excel模板</font></a>编辑后上传文件</td></tr>
　　　　　<tr>
