...
<body>
 <h2 style="text-align: center;"><?php echo ($yy); ?>学年<?php echo ($_SESSION['login']['classes']); ?>班级奖学金以及个人荣誉汇总表</h2>
 <form id="form1" action="<?php echo U('Together/together1');?>" method="post">
