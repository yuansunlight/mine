...
<form enctype="multipart/form-data" action="<?php echo U('upload');?>" method="post">
  ...
  <table>
    ...
    <tr><td>请先<a href="/sss/Public/home/excel/student.xls" rel="external nofollow" ><font style="color: blue;" >下载添加学生excel模板</font></a>编辑后上传文件</td></tr>
　　　　　<tr>
